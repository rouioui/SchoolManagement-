 ...
 */
class getCategorieBlogRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategorieBlogRepository' shared autowired service.
     *
     * @return \App\Repository\CategorieBlogRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategorieBlogRepository.php';

        return $container->privates['App\\Repository\\CategorieBlogRepository'] = new \App\Repository\CategorieBlogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
