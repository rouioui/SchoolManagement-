 ...
 */
class getNumberExamsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NumberExamsRepository' shared autowired service.
     *
     * @return \App\Repository\NumberExamsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NumberExamsRepository.php';

        return $container->privates['App\\Repository\\NumberExamsRepository'] = new \App\Repository\NumberExamsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
