 ...
 */
class getMsgRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MsgRepository.php';

        return $container->privates['App\\Repository\\MsgRepository'] = new \App\Repository\MsgRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
